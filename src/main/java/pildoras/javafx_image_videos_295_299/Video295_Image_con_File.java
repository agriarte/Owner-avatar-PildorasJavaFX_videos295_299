 ...
 * @author Pedro
 */
public class Video295_Image_con_File extends Application {
    
    @Override
 public void start(Stage primaryStage) {
        
         // Ruta de la imagen utilizando el sistema de archivos independiente del sistema operativo
        String nombreArchivo = "foto1.jpg";
        String rutaImagen = "G:" + File.separator + "OtrosProgramas" + File.separator + "Downloads" + File.separator + nombreArchivo;
        ...
        // Crear un objeto Image desde el archivo
